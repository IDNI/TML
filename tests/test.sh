...
cd ..
g++ -std=c++1y transform.cpp output.cpp bdd.cpp dict.cpp driver.cpp input.cpp lp.cpp main.cpp query.cpp rule.cpp -W -Wall -Wpedantic -otml -O3 -flto # compile tml with optimization flags
cd -
